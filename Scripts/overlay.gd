...
@onready var soul_fragment_amount : SoulFragment # Replace with soul fragment variable. Update line 22 also
...
func _ready():
	...
	sf_label.text = "Soul Fragments: " % soul_fragment_amount.sf_amount
...
func update_soul_fragment(): # Call when needing to update Soul Fragment
	soul_fragment_amount.sf_amount = soul_fragment_amount.sf_amount
	sf_label.text = "Soul Fragments: " % soul_fragment_amount.sf_amount
